...
2. SQL 기본 및 활용 (40 문항)
   ...
   2.1 [SQL 활용](#22-SQL-활용)

   ~~2.1 [SQL 최적화 기본원리](#23-SQL-최적화-기본원리)~~
...
| COUNT(\*)                         | COUNT(표현식)                    |
| :-------------------------------- | :------------------------------- |
| NULL 값을 **포함**한 헹의 수 출력 | NULL값을 **제외**한 헹의 수 출력 |
...
2. 서브쿼리는 단일행(Single Row) 또는 복수행(Multiple Row) 비교 연산자와 함꼐 사용 가능하다.
...
| HAVING 절                       | 그룹함수와 함꼐 사용될 때 그뤂핑된 결과에 대해 부가적인 조건을 주기 위해서 사용                                                     |
